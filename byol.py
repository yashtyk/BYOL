...
class BYOL(nn.Module):
    def __init__(
        ...
        DEFAULT_AUG = torch.nn.Sequential(
            ...
            T.RandomResizedCrop((image_size, image_size),scale=(0.9, 1), ratio = (1, 1) ),
            T.Normalize(mean=[0.5], std=[0.5]),
        )
        ...
        self.forward(torch.randn(2, num_channel, image_size, image_size, device=device))
    ...
    def forward(
        ...
        if y is not None:
            ...
            classification_loss  = self.loss(out, y)
